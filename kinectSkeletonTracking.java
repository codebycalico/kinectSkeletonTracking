...
boolean leftHandOpen = false;
boolean rightHandOpen = false;
...
void drawBody(KJoint[] joints) {
  ...
  drawBone(joints, KinectPV2.JointType_SpineShoulder, KinectPV2.JointType_ShoulderRight, "rightspineshoulder");
  drawBone(joints, KinectPV2.JointType_SpineShoulder, KinectPV2.JointType_ShoulderLeft, "leftspineshoulder");
...
void drawBone(KJoint[] joints, int jointType1, int jointType2, String jointName) {
  ...
  if(joints[jointType1].getX() > 0 && joints[jointType1].getY() > 0){
    pushMatrix();
  ...
  //scale everything to 0-127 / midi range
    ...
    myMessage.add(new float[] {joints[jointType1].getX(),joints[jointType1].getY(), joints[jointType1].getZ()});
    ellipse(0, 0, 25, 25);
    popMatrix();
